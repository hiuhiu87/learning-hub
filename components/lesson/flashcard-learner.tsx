  ...
  return (
    <div className="space-y-6 text-slate-900 transition dark:text-slate-100">
      <div className="flex items-center justify-between">
        <Badge
          variant="secondary"
          className="border-slate-200/60 bg-white text-slate-700 transition dark:border-white/10 dark:bg-white/10 dark:text-white">
          Flashcard carousel
        </Badge>
          ...
          <CardContent className="flex items-start gap-3 p-5 text-sm">
            <div>
              ...
              <p className="text-amber-600 dark:text-amber-200">
                You’ve flagged {markedCount} card{markedCount !== 1 ? "s" : ""}{" "}
                to revisit. Keep reviewing until each feels effortless.
              </p>
            </div>
          </CardContent>
        </Card>
